...
{
    /// <inheritdoc />
    public partial class AddCurrentModelChanges : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WarrantyMonth = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_product_tag_relations", x => new { x.ProductId, x.TagId });
                    table.ForeignKey(
                        name: "FK_product_tag_relations_product_tags_TagId",
                        column: x => x.TagId,
                        principalTable: "product_tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_product_tag_relations_products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_product_tag_relations_TagId",
